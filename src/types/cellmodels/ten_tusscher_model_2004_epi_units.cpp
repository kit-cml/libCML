...
#include "ten_tusscher_model_2004_epi_units.hpp"
#include <cmath>
#include <cstdlib>
...
ten_tusscher_model_2004_epi_units::ten_tusscher_model_2004_epi_units()
{
algebraic_size = 67;
constants_size = 46;
states_size = 17;
...
void ten_tusscher_model_2004_epi_units::initConsts( )
{
STATES[V] = -86.2;
...
void ten_tusscher_model_2004_epi_units::computeRates( double TIME, double *CONSTANTS, double *RATES, double *STATES, double *ALGEBRAIC )
{
...
void ten_tusscher_model_2004_epi_units::solveAnalytical(double dt)
{
// Exact solution
