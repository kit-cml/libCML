...
void Tomek_model::___initConsts(double type)
{
  ...
  STATES[CaMKt] = (CONSTANTS[celltype] == 1.00000 ? 0.0129 : CONSTANTS[celltype] == 2.00000 ? 0.0192
                                                                                            : 0.0111);
  STATES[cass] = (CONSTANTS[celltype] == 1.00000 ? 5.77E-05 : CONSTANTS[celltype] == 2.00000 ? 6.58E-05
                                                                                             : 7.0305e-5);
  ...
  STATES[nai] = (CONSTANTS[celltype] == 1.00000 ? 12.1025 : CONSTANTS[celltype] == 2.00000 ? 15.0038
                                                                                           : 12.1025);
  STATES[nass] = (CONSTANTS[celltype] == 1.00000 ? 12.8366 : CONSTANTS[celltype] == 2.00000 ? 15.0043
                                                                                            : 12.1029);
  STATES[ki] = (CONSTANTS[celltype] == 1.00000 ? 142.6951 : CONSTANTS[celltype] == 2.00000 ? 143.0403
                                                                                           : 142.3002);
  STATES[kss] = (CONSTANTS[celltype] == 1.00000 ? 142.6951 : CONSTANTS[celltype] == 2.00000 ? 143.0402
                                                                                            : 142.3002);
  STATES[cansr] = (CONSTANTS[celltype] == 1.00000 ? 1.8119 : CONSTANTS[celltype] == 2.00000 ? 1.9557
                                                                                            : 1.5211);
  STATES[cajsr] = (CONSTANTS[celltype] == 1.00000 ? 1.8102 : CONSTANTS[celltype] == 2.00000 ? 1.9593
                                                                                            : 1.5214);
  STATES[cai] = (CONSTANTS[celltype] == 1.00000 ? 6.63E-05 : CONSTANTS[celltype] == 2.00000 ? 8.17E-05
                                                                                            : 8.1583e-05);
  CONSTANTS[cli] = 24.0;
  ...
  STATES[m] = (CONSTANTS[celltype] == 1.00000 ? 7.43E-04 : CONSTANTS[celltype] == 2.00000 ? 7.38E-04
                                                                                          : 8.0572e-4);
  STATES[h] = (CONSTANTS[celltype] == 1.00000 ? 0.836 : CONSTANTS[celltype] == 2.00000 ? 0.8365
                                                                                       : 0.8286);
  STATES[j] = (CONSTANTS[celltype] == 1.00000 ? 0.8359 : CONSTANTS[celltype] == 2.00000 ? 0.8363
                                                                                        : 0.8284);
  STATES[hp] = (CONSTANTS[celltype] == 1.00000 ? 0.6828 : CONSTANTS[celltype] == 2.00000 ? 0.6838
                                                                                         : 0.6707);
  STATES[jp] = (CONSTANTS[celltype] == 1.00000 ? 0.8357 : CONSTANTS[celltype] == 2.00000 ? 0.8358
                                                                                         : 0.8281);
  CONSTANTS[GNa] = 11.7802;
  STATES[mL] = (CONSTANTS[celltype] == 1.00000 ? 1.52E-04 : CONSTANTS[celltype] == 2.00000 ? 1.51E-04
                                                                                           : 1.629e-4);
  CONSTANTS[thL] = 200;
  STATES[hL] = (CONSTANTS[celltype] == 1.00000 ? 0.5401 : CONSTANTS[celltype] == 2.00000 ? 0.5327
                                                                                         : 0.5255);
  STATES[hLp] = (CONSTANTS[celltype] == 1.00000 ? 0.3034 : CONSTANTS[celltype] == 2.00000 ? 0.2834
                                                                                          : 0.2872);
  CONSTANTS[GNaL_b] = 0.0279;
  CONSTANTS[Gto_b] = 0.16;
  STATES[a] = (CONSTANTS[celltype] == 1.00000 ? 9.27E-04 : CONSTANTS[celltype] == 2.00000 ? 9.25E-04
                                                                                          : 9.5098e-4);
  CONSTANTS[EKshift] = 0;
  STATES[iF] = 0.9996;
  STATES[iS] = (CONSTANTS[celltype] == 1.00000 ? 0.9996 : CONSTANTS[celltype] == 2.00000 ? 0.5671
                                                                                         : 0.5936);
  STATES[ap] = (CONSTANTS[celltype] == 1.00000 ? 4.72E-04 : CONSTANTS[celltype] == 2.00000 ? 4.71E-04
                                                                                           : 4.8454e-4);
  STATES[iFp] = 0.9996;
  STATES[iSp] = (CONSTANTS[celltype] == 1.00000 ? 0.9996 : CONSTANTS[celltype] == 2.00000 ? 0.6261
                                                                                          : 0.6538);
  CONSTANTS[Kmn] = 0.002;
  CONSTANTS[k2n] = 500;
  CONSTANTS[PCa_b] = 8.3757e-05;
  STATES[d] = (CONSTANTS[celltype] == 1.00000 ? 0.0 : CONSTANTS[celltype] == 2.00000 ? 0.0
                                                                                     : 8.1084e-9);
  CONSTANTS[Aff] = 0.6;
  STATES[ff] = 1.0;
  STATES[fs] = (CONSTANTS[celltype] == 1.00000 ? 0.9485 : CONSTANTS[celltype] == 2.00000 ? 0.92
                                                                                         : 0.939);
  STATES[fcaf] = 1.0;
  STATES[fcas] = 0.9999;
  STATES[jca] = 1.0;
  STATES[ffp] = 1.0;
  STATES[fcafp] = 1.0;
  STATES[nca_ss] = (CONSTANTS[celltype] == 1.00000 ? 3.09E-04 : CONSTANTS[celltype] == 2.00000 ? 5.14E-04
                                                                                               : 6.6462e-4);
  STATES[nca_i] = (CONSTANTS[celltype] == 1.00000 ? 5.30E-04 : CONSTANTS[celltype] == 2.00000 ? 0.0012
                                                                                              : 0.0012);
  CONSTANTS[tjca] = 75;
  CONSTANTS[vShift] = 0;
  CONSTANTS[offset] = 0;
  ...
  STATES[C1] = (CONSTANTS[celltype] == 1.00000 ? 6.79E-04 : CONSTANTS[celltype] == 2.00000 ? 6.96E-04
                                                                                           : 7.0344e-4);
  STATES[C2] = (CONSTANTS[celltype] == 1.00000 ? 8.29E-04 : CONSTANTS[celltype] == 2.00000 ? 8.27E-04
                                                                                           : 8.5109e-4);
  STATES[C3] = (CONSTANTS[celltype] == 1.00000 ? 0.9982 : CONSTANTS[celltype] == 2.00000 ? 0.9979
                                                                                         : 0.9981);
  STATES[I] = (CONSTANTS[celltype] == 1.00000 ? 9.54E-06 : CONSTANTS[celltype] == 2.00000 ? 1.88E-05
                                                                                          : 1.3289e-5);
  STATES[O] = (CONSTANTS[celltype] == 1.00000 ? 2.76E-04 : CONSTANTS[celltype] == 2.00000 ? 5.42E-04
                                                                                          : 3.7585e-4);
  CONSTANTS[alpha_1] = 0.154375;
  CONSTANTS[beta_1] = 0.1911;
  CONSTANTS[GKs_b] = 0.0011;
  STATES[xs1] = (CONSTANTS[celltype] == 1.00000 ? 0.2309 : CONSTANTS[celltype] == 2.00000 ? 0.2653
                                                                                          : 0.248);
  STATES[xs2] = (CONSTANTS[celltype] == 1.00000 ? 1.70E-04 : CONSTANTS[celltype] == 2.00000 ? 1.69E-04
                                                                                            : 1.7707e-4);
  ...
  CONSTANTS[tauCa] = 0.2;
  CONSTANTS[bt] = 4.75;
  STATES[Jrel_np] = (CONSTANTS[celltype] == 1.00000 ? 2.82E-24 : CONSTANTS[celltype] == 2.00000 ? 0.
                                                                                                : 1.6129e-22);
  STATES[Jrel_p] = (CONSTANTS[celltype] == 1.00000 ? 0. : CONSTANTS[celltype] == 2.00000 ? 0.
                                                                                         : 1.2475e-20);
                                  ...
                                  double max_dV)
{
  ...
  {
    // printf("TIME > time_point ms\n");
    if (std::abs(RATES[V] * time_step) <= min_dV)
    { // Slow changes in V
      // printf("dV/dt <= 0.2\n");
    ...
    else if (std::abs(RATES[V] * time_step) >= max_dV)
    { // Fast changes in V
      // printf("dV/dt >= 0.8\n");
