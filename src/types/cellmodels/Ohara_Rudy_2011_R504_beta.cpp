...
#include "Ohara_Rudy_2011_R504_beta.hpp"
#include <cmath>
#include <cstdlib>
...
STATES[hf] = 1;
STATES[hs] = 1;
//CONSTANTS[GNa] = 75*(993./2000.);
CONSTANTS[GNa] = 37.2375;
STATES[j] = 1;
STATES[hsp] = 1;
STATES[jp] = 1;
STATES[mL] = 0;
...
STATES[hL] = 1;
STATES[hLp] = 1;
//CONSTANTS[GNaL_b] = 0.0075*(99.3/200.);
CONSTANTS[GNaL_b] = 0.003724;
...
void Ohara_Rudy_2011_R504_beta::___applyDutta()
{
...
void Ohara_Rudy_2011_R504_beta::___applyDrugEffect(double conc, const double *hill)
{
...
void Ohara_Rudy_2011_R504_beta::initConsts()
{
	___initConsts(0.);
}

void Ohara_Rudy_2011_R504_beta::initConsts(double type)
{
	___initConsts(type);
}

void Ohara_Rudy_2011_R504_beta::initConsts(double type, double conc, const double *hill, bool is_dutta)
{
  ___initConsts(type);
...
void Ohara_Rudy_2011_R504_beta::computeRates( double TIME, double *CONSTANTS, double *RATES, double *STATES, double *ALGEBRAIC )
{
CONSTANTS[cmdnmax] = (CONSTANTS[celltype]==1.00000 ?  CONSTANTS[cmdnmax_b]*1.30000 : CONSTANTS[cmdnmax_b]);
CONSTANTS[GNaL] = (CONSTANTS[celltype]==1.00000 ?  CONSTANTS[GNaL_b]*0.600000 : CONSTANTS[GNaL_b]);
CONSTANTS[Gto] = (CONSTANTS[celltype]==1.00000 ?  CONSTANTS[Gto_b]*4.00000 : CONSTANTS[celltype]==2.00000 ?  CONSTANTS[Gto_b]*4.00000 : CONSTANTS[Gto_b]);
...
ALGEBRAIC[thf] = 1.15000/( 1.43200e-05*exp(- (STATES[V]+1.19600)/6.28500)+ 6.14900*exp((STATES[V]+0.509600)/20.2700));
...
void Ohara_Rudy_2011_R504_beta::solveAnalytical(double dt)
{
#ifdef EULER
...
double Ohara_Rudy_2011_R504_beta::set_time_step(double TIME,
  double time_point,
